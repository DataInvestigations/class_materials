...
- Some individual projects left but much will be integrated into the group project
- Next group project due: Preliminary analyses and figures for *Final group presentation*
  - every group member must contribute one figure + one analysis
  - these should be decided on in advance and communicated among member
...
-   Parameters of a linear model typically characterize *differences* in
    means
-   These are differences per unit of change for *continuous*
    predictors,
...
-   Default R behaviour: *treatment contrasts*
    -   $\beta_1$ = expected value in baseline group (= first level of
        the factor variable, by default the first in alphabetical
        order, labeled **Intercept**);
